...
\prob{
  ...
  symetrii i przesunięcia? Czy do każdej podanej izometrii umiemy łatwo podać izometrię odwrotną?
}
...
\section{Kategorie}
\begin{prob}
  Pomyśl o zbiorach i funkcjach lub grupach i homeomorfizmach oraz uzupełnij definicję kategorii:
